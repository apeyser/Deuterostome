...
shifted down by 8 is nonzero, then the process dies as if it had been
signaled by that value (the raw, operating system signal integer);
otherwise the process exits with the bottom 8 bits.
