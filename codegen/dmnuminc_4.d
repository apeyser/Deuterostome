...
[ /ADD /SUB /MUL /DIV /PWR /MOD ] { /op name
...
0 exch getinterval dir (dmnuminc.c) writefile
dmsave restore 
} def
...
AMbase 0 XYmoveSS 0 exch getinterval /Rss name Rss toscrolled
} def

/moveSA { /dt name /st name
AMbase 0 XYmoveSA 0 exch getinterval /Rss name Rss toscrolled
} def

/moveAS { /dt name /st name
AMbase 0 XYmoveAS 0 exch getinterval /Rss name Rss toscrolled
} def

/moveAA { /dt name /st name
AMbase 0 XYmoveAA 0 exch getinterval /Rss name Rss toscrolled
} def

/encode { /dt name
AMbase 0 DYencode 0 exch getinterval /Rss name Rss toscrolled 
} def

/value { /st name
AMbase 0 XLvalue 0 exch getinterval /Rss name Rss toscrolled 
} def

/test { /st name
AMbase 0 XDtest 0 exch getinterval /Rss name Rss toscrolled 
} def

/dySS { /op name /st name /dt name 
AMbase 0 XYdyOPSS 0 exch getinterval /Rss name Rss toscrolled
} def

/dyAS { /op name /st name /dt name 
AMbase 0 XYdyOPAS 0 exch getinterval /Rss name Rss toscrolled
} def

/dySA { /op name /st name /dt name 
AMbase 0 XYdyOPSA 0 exch getinterval /Rss name Rss toscrolled
} def

/dyAA { /op name /st name /dt name 
AMbase 0 XYdyOPAA 0 exch getinterval /Rss name Rss toscrolled
} def

/moS { /op name /dt name
AMbase 0 YmoOPS 0 exch getinterval /Rss name Rss toscrolled
} def

/moA { /op name /dt name
AMbase 0 YmoOPA 0 exch getinterval /Rss name Rss toscrolled
} def
