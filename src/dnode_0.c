...
char* original_dir;
// setup by makefile, defines which directory, relative to original_dir
// to use for the startup file
char startup_dir[] = STARTUP_DIR;
// points the frame holding ^^^, at the bottom of the vm
B* startup_dir_frame;
